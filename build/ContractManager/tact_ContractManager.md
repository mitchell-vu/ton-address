...
## JettonData
TLB: `_ owner:address wallet_code:^cell = JettonData`
Signature: `JettonData{owner:address,wallet_code:^cell}`
...
## TransferContact
TLB: `transfer_contact#80c579a3 amount:coins receiver:^string = TransferContact`
Signature: `TransferContact{amount:coins,receiver:^string}`

## TransferWallet
TLB: `transfer_wallet#0bb47c6f amount:coins receiver:address = TransferWallet`
Signature: `TransferWallet{amount:coins,receiver:address}`
...
55916: Missing receiver or amount
