...
export function loadJettonData(slice: Slice) {
    ...
    return { $$type: 'JettonData' as const, owner: _owner, wallet_code: _wallet_code };
}
...
export function storeTransferContact(src: TransferContact) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(2160425379, 32);
        b_0.storeCoins(src.amount);
        b_0.storeStringRefTail(src.receiver);
    };
}

export function loadTransferContact(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2160425379) { throw Error('Invalid prefix'); }
    let _amount = sc_0.loadCoins();
    let _receiver = sc_0.loadStringRefTail();
    return { $$type: 'TransferContact' as const, amount: _amount, receiver: _receiver };
}

function loadTupleTransferContact(source: TupleReader) {
    let _amount = source.readBigNumber();
    let _receiver = source.readString();
    return { $$type: 'TransferContact' as const, amount: _amount, receiver: _receiver };
}

function storeTupleTransferContact(source: TransferContact) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.amount);
...
function dictValueParserTransferContact(): DictionaryValue<TransferContact> {
    return {
        serialize: (src, buidler) => {
            buidler.storeRef(beginCell().store(storeTransferContact(src)).endCell());
        },
        parse: (src) => {
            return loadTransferContact(src.loadRef().beginParse());
        }
    }
}
...
export function storeTransferWallet(src: TransferWallet) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(196377711, 32);
        b_0.storeCoins(src.amount);
        b_0.storeAddress(src.receiver);
    };
}

export function loadTransferWallet(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 196377711) { throw Error('Invalid prefix'); }
    let _amount = sc_0.loadCoins();
    let _receiver = sc_0.loadAddress();
    return { $$type: 'TransferWallet' as const, amount: _amount, receiver: _receiver };
}

function loadTupleTransferWallet(source: TupleReader) {
    let _amount = source.readBigNumber();
    let _receiver = source.readAddress();
    return { $$type: 'TransferWallet' as const, amount: _amount, receiver: _receiver };
}

function storeTupleTransferWallet(source: TransferWallet) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.amount);
...
function dictValueParserTransferWallet(): DictionaryValue<TransferWallet> {
    return {
        serialize: (src, buidler) => {
            buidler.storeRef(beginCell().store(storeTransferWallet(src)).endCell());
        },
        parse: (src) => {
            return loadTransferWallet(src.loadRef().beginParse());
        }
    }
}
...
const JettonDefaultWallet_errors: { [key: number]: { message: string } } = {
    ...
    55916: { message: `Missing receiver or amount` },
...
const JettonDefaultWallet_types: ABIType[] = [
    ...
    {"name":"JettonData","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"wallet_code","type":{"kind":"simple","type":"cell","optional":false}}]},
    ...
    {"name":"TransferContact","header":2160425379,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"receiver","type":{"kind":"simple","type":"string","optional":false}}]},
    {"name":"TransferWallet","header":196377711,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}}]},
]
